...
class Settings(BaseSettings):
    ...
    official_auto_run_enabled: bool = Field(default=False, validation_alias="OFFICIAL_AUTO_RUN_ENABLED")
    official_auto_run_interval_seconds: int = Field(default=900, validation_alias="OFFICIAL_AUTO_RUN_INTERVAL_SECONDS")
    official_auto_run_initial_delay_seconds: int = Field(default=15, validation_alias="OFFICIAL_AUTO_RUN_INITIAL_DELAY_SECONDS")
